        ...
        <div class="container text-center">
            ...
            <div class="row h-100">
                <div class="col-lg-8 mx-auto align-self-center">
                    ...
                    <p><span class="opacity-70 mr-1 text-success">By</span> <a class="text-primary" href="#">{{$post->user->name}}</a></p>
                    <p><img class="avatar avatar-sm" src="{{\Thomaswelton\LaravelGravatar\Facades\Gravatar::src($post->user->email)}}" alt="..."></p>
                    ...
                    <div class="col-lg-8 mx-auto">
                        ...
                        <script>
                            ...
                            (function() { // DON'T EDIT BELOW THIS LINE
                                ...
                                s.src = 'https://project-4hynzfokj1.disqus.com/embed.js';
